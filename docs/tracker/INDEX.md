...
**Overall: [████████░░] 81% — 7 done · 1 wip / 10**

| Tracker | Progress | Open | Note |
|---|---|---|---|
| [adoption-audit](adoption-audit.md) | `[████████░░] 81%` | 3 | AUD-7 benchmark corpus + 2 owner actions outside the repo |
| [WORK_TRACKER (legacy)](../WORK_TRACKER.md) | `[██████████] 100%` | 0 | Code-review remediation, 2026-07-15 — closed, retained for history |

## Audits (no open tracker rows)
