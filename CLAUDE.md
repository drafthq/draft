...
- **`scripts/benchmark/`** — Efficacy-benchmark harness (`bench-checkout.sh`, `bench-grade.sh`, `bench-report.sh`). Protocol in `docs/internal/benchmark/README.md`. Not part of the shipped plugin.
